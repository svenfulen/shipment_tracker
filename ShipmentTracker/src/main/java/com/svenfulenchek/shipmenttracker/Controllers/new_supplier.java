...
public class new_supplier {
    ...
    public void onSubmit() throws Exception {
        ...
        if (formIsCorrect(name, phone, website, email, address, notes)) {
            Supplier new_supplier = new Supplier(name, address, email, phone, website, notes);
            database_operation.addSupplier(new_supplier);
            Stage new_supplier_stage = (Stage) name_field.getScene().getWindow();
            new_supplier_stage.close();
        }
